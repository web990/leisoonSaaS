...
/**
 * @see \app\common\model\Type
 * @mixin \app\common\model\Type
 * @method mixed getPath(int $id) static 返回图片路径
 * @method mixed getInfo(int $id,string $path) static 返回单条信息/字段信息
 *
