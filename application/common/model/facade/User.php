...
/**
 * @see \app\common\model\Book
 * @mixin \app\common\model\Book
 * @method array getInfo(integer $uid,string $field) static 返回userInfo
 * @method array getUsername(integer $uid) static 返回Username
 * @method array change(array $data=null) static 添加修改新用户
 * @method integer|string|array login(string $username, string $password, integer $type = 1) static 用户登录认证
 * @method bool logout(string $token) static 注销当前用户
 * @method bool|integer checkLogin(string $token) static 验证是否登录
 * @method int del(mixed $ids, bool $force = false) static 软删除
 * @method bool updateUserFields(integer $uid, array $data) static 更新字段
 *
