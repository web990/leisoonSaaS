...
/**
 * @see \app\admin\model\AdminType
 * @mixin \app\admin\model\AdminType
 * @method array getType(int $pid) static 返回id->title数组
 * @method mixed getTitle(int $id) static 返回title
 * @method mixed getValueTitle(int $pid,int $value) static根据Value返回title
 * @method mixed getStatus(string $type,int $value) 返回状态数组/信息
 *
...
class Type extends Facade
{
    ...
    {
        return 'app\admin\model\AdminType';
    }
}